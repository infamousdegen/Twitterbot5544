...
#                 time.sleep(5)
        ...
        for user in tweepy.Cursor(api.friends, screen_name=user_15).items(5):
            ...
            latest_following = str(user.screen_name)
            if (latest_following not in recent_following_user15):
                recent_following_user15.append(latest_following)
                message=user_15+" just followed " + "https://twitter.com/"+latest_following
                base_url='https://api.telegram.org/bot5230523338:AAG_rRN7sCWq29CulfA-6zfYnE2C-Ej-UDk/sendMessage?chat_id=-1001180497796&text={}'.format(message)
                requests.get(base_url)
                base_url2='https://api.telegram.org/bot5132351109:AAHolO_uuOj3uSq4e-W_77erZfTcSCdcrwo/sendMessage?chat_id=-1001679011206&text={}'.format(message)
                requests.get(base_url2)
...
for user in tweepy.Cursor(api.friends, screen_name=user_12).items(10):
    new_follower=str(user.screen_name)
    recent_following_user12.append(new_follower)
time.sleep(40)
...
for user in tweepy.Cursor(api.friends, screen_name=user_13).items(10):
    new_follower=str(user.screen_name)
    recent_following_user13.append(new_follower)
time.sleep(40)
...
for user in tweepy.Cursor(api.friends, screen_name=user_14).items(10):
    new_follower=str(user.screen_name)
    recent_following_user14.append(new_follower)
time.sleep(40)


recent_following_user15=[]
user_15="zksoju"
for user in tweepy.Cursor(api.friends, screen_name=user_15).items(10):
    new_follower=str(user.screen_name)
    recent_following_user15.append(new_follower)
time.sleep(40)



recent_following_user16=[]
user_16="hunting_artemis"
for user in tweepy.Cursor(api.friends, screen_name=user_16).items(10):
    new_follower=str(user.screen_name)
    recent_following_user16.append(new_follower)
time.sleep(40)
